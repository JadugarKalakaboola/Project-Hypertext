        ...
        <ContainerBlock>
            {confetti ? <div><Confetti className='w-screen h-screen'/></div>: <div></div>}
                ...
                <div className="lg:flex py-5 justify-between">
                    ...
                    <div style={mounted && theme==='light' ? lightButtonStyles : darkButtonStyles} className="lg:mx-auto p-5 flex justify-center rounded-3xl">
                        <DoughnutChart />
                    </div>
                    </div>
            ...
            <div className='w-11/12 mx-auto py-10'>
                ...
                <div className='lg:grid grid-cols-2 gap-20 py-10'>
                    <div style={mounted && theme==='light' ? lightPressedButtonStyles : darkPressedButtonStyles} className="p-2 rounded-lg"><ClassXAPI /></div>
                    <div style={mounted && theme==='light' ? lightPressedButtonStyles : darkPressedButtonStyles} className="p-2 rounded-lg"><ClassXIIAPISc /></div>
                    <div style={mounted && theme==='light' ? lightPressedButtonStyles : darkPressedButtonStyles} className="p-2 rounded-lg"><ClassXIIAPICom /></div>
                    <div style={mounted && theme==='light' ? lightPressedButtonStyles : darkPressedButtonStyles} className="p-2 rounded-lg"><ClassXIIAPIHu /></div>
